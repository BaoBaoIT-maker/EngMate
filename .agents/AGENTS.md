...
- **analysis-explain-project:** dùng để phân tích, giải thích cấu trúc dự án, stack công nghệ, luồng chức năng và file/module quan trọng của EngMate.
- Khi người dùng hỏi về tổng quan dự án, architecture, hoặc cần mô tả repo một cách logic, hãy ưu tiên dùng skill này.
